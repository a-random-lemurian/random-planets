...
class Name():
    def star():
        region = ''.join(random.choices(string.digits, k=8))
        quadrant_x = ''.join(random.choices(string.digits, k=4))
        quadrant_y = ''.join(random.choices(string.digits, k=4))
        quadrant_z = ''.join(random.choices(string.digits, k=4))
        star_num = ''.join(random.choices(string.digits, k=8))
